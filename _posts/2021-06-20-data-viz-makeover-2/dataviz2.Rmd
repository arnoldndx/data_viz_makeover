...
14   | Now we will create the custom tooltip so that the user can get an informative analysis when he mouses over the respective bubble. ![Step 14](step14a.png) To create the reactive color coding and "+/-" prefix for the balance of trade, we will need to create two calculated fields, one field, _bot_neg_ will be null when the balance of trade is positive, and the other field, _bot_pos_ will be null when the balance of trade is negative. Use an IF statement to do this. | ![Step 14](step14b.png)
