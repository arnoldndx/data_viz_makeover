...
For the first approach, we will establish a listing of all news sources, and then check each article text for the presence of other news sources. We will use the detects to generate an adjacency matrix to visualise the links between articles. The primary source will be the news source quoted and the derivative source is the article doing the quoting.
