...
### 2.1.1. Combine articles into single table for checking
...
### 2.1.2. Load cleaned data and convert to article data into analysable dataframe
...
It is noted that _All News Today_ is the most vehemently anti-government and anti-GAStech news source, while it is also the most pro-POK news source. This is not surprising, and _All News Today_ could have links with the POK organisation and senior leadership.
